...
(() => {
  ...
  // node_modules/.cache/storybook/1c3385a5d25e538d10b518b310c74d3ca2690b6aaffeadccd74da79736171f86/sb-manager/a11y-3/manager-bundle.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();

  // node_modules/.pnpm/@storybook+addon-a11y@10.1.10_storybook@10.1.10_@testing-library+dom@10.4.1_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@storybook/addon-a11y/dist/manager.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();

  // node_modules/.pnpm/@storybook+addon-a11y@10.1.10_storybook@10.1.10_@testing-library+dom@10.4.1_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@storybook/addon-a11y/dist/_browser-chunks/chunk-3FKQRDK3.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  var ADDON_ID = "storybook/a11y", PANEL_ID = `${ADDON_ID}/panel`, PARAM_KEY = "a11y", UI_STATE_ID = `${ADDON_ID}/ui`, RESULT = `${ADDON_ID}/result`, REQUEST = `${ADDON_ID}/request`, RUNNING = `${ADDON_ID}/running`, ERROR = `${ADDON_ID}/error`, MANUAL = `${ADDON_ID}/manual`, SELECT = `${ADDON_ID}/select`, DOCUMENTATION_LINK = "writing-tests/accessibility-testing", DOCUMENTATION_DISCREPANCY_LINK = `${DOCUMENTATION_LINK}#why-are-my-tests-failing-in-different-environments`, EVENTS = { RESULT, REQUEST, RUNNING, ERROR, MANUAL, SELECT }, STATUS_TYPE_ID_COMPONENT_TEST = "storybook/component-test", STATUS_TYPE_ID_A11Y = "storybook/a11y";

  // node_modules/.pnpm/@storybook+addon-a11y@10.1.10_storybook@10.1.10_@testing-library+dom@10.4.1_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@storybook/addon-a11y/dist/_browser-chunks/chunk-4BE7D4DS.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  ...
  // node_modules/.pnpm/storybook@10.1.10_@testing-library+dom@10.4.1_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/storybook/dist/highlight/index.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  ...
  function $e02a7d9cb1dc128c$export$c74125a8e3af6bb2(name) {
    ...
    let ITEM_SLOT_NAME = name + "CollectionItemSlot", ITEM_DATA_ATTR = "data-radix-collection-item", CollectionItemSlot = react_default.forwardRef((props, forwardedRef) => {
      ...
      })), react_default.createElement($5e63c961fc1ce211$export$8c6ed5c666ac1360, {
        [ITEM_DATA_ATTR]: "",
        ref: composedRefs
      }, children);
    });
...
${target} {}`
  ...
  var impactStatus = {
  ...
  }, Filters = (props) => createElement("svg", { ...props }, createElement("defs", null, createElement("filter", { id: "protanopia" }, createElement(
    "feColorMatrix",
    {
      in: "SourceGraphic",
      type: "matrix",
  ...
  )), createElement("filter", { id: "protanomaly" }, createElement(
    "feColorMatrix",
    {
      in: "SourceGraphic",
      type: "matrix",
  ...
  )), createElement("filter", { id: "deuteranopia" }, createElement(
    "feColorMatrix",
    {
      in: "SourceGraphic",
      type: "matrix",
  ...
  )), createElement("filter", { id: "deuteranomaly" }, createElement(
    "feColorMatrix",
    {
      in: "SourceGraphic",
      type: "matrix",
  ...
  )), createElement("filter", { id: "tritanopia" }, createElement(
    "feColorMatrix",
    {
      in: "SourceGraphic",
      type: "matrix",
  ...
  )), createElement("filter", { id: "tritanomaly" }, createElement(
    "feColorMatrix",
    {
      in: "SourceGraphic",
      type: "matrix",
  ...
  )), createElement("filter", { id: "achromatopsia" }, createElement(
    "feColorMatrix",
    {
      in: "SourceGraphic",
      type: "matrix",
  ...
  )))), iframeId = "storybook-preview-iframe", baseList = [
    ...
    { name: "grayscale" }
  ], getFilter = (filterName) => filterName ? filterName === "blurred vision" ? "blur(2px)" : filterName === "grayscale" ? "grayscale(100%)" : `url('#${filterName}')` : "none", Hidden = styled.div({
    "&, & svg": {
      position: "absolute",
      width: 0,
      height: 0
    ...
    let [filter, setFilter] = useState(null), options = baseList.map(({ name, percentage }) => {
      let description = percentage !== void 0 ? `${percentage}% of users` : void 0;
      return {
        title: name,
        description,
        icon: react_default.createElement(ColorIcon, { $filter: name }),
        value: name
      };
    });
    return react_default.createElement(react_default.Fragment, null, filter && react_default.createElement(
      Global,
      {
        styles: {
          [`#${iframeId}`]: {
    ...
    ), react_default.createElement(Hidden, null, react_default.createElement(Filters, null)));
  }, Title2 = () => {
